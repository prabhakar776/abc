...
/**
 * Provides the base implementation for the submission version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.instructure.canvas.service.impl.SubmissionVersionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SubmissionVersionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SubmissionVersionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.instructure.canvas.service.SubmissionVersionLocalServiceUtil} to access the submission version local service.
	 */
	...
	@Override
	public SubmissionVersion addSubmissionVersion(
		SubmissionVersion submissionVersion) throws SystemException {
		submissionVersion.setNew(true);

		return submissionVersionPersistence.update(submissionVersion);
	}
	 ...
	 */
	@Override
	public SubmissionVersion createSubmissionVersion(long submissionId) {
		return submissionVersionPersistence.create(submissionId);
	}
	...
	@Override
	public SubmissionVersion deleteSubmissionVersion(long submissionId)
		throws PortalException, SystemException {
		return submissionVersionPersistence.remove(submissionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SubmissionVersion deleteSubmissionVersion(
		SubmissionVersion submissionVersion) throws SystemException {
		return submissionVersionPersistence.remove(submissionVersion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SubmissionVersion.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return submissionVersionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return submissionVersionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SubmissionVersion fetchSubmissionVersion(long submissionId)
		throws SystemException {
		return submissionVersionPersistence.fetchByPrimaryKey(submissionId);
	}
	 ...
	 */
	@Override
	public SubmissionVersion getSubmissionVersion(long submissionId)
		throws PortalException, SystemException {
		return submissionVersionPersistence.findByPrimaryKey(submissionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return submissionVersionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SubmissionVersion> getSubmissionVersions(int start, int end)
		throws SystemException {
		return submissionVersionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSubmissionVersionsCount() throws SystemException {
		return submissionVersionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SubmissionVersion updateSubmissionVersion(
		SubmissionVersion submissionVersion) throws SystemException {
		return submissionVersionPersistence.update(submissionVersion);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.instructure.canvas.model.SubmissionVersion",
			submissionVersionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = submissionVersionPersistence.getDataSource();
	...
	private SubmissionVersionLocalServiceClpInvoker _clpInvoker = new SubmissionVersionLocalServiceClpInvoker();
}