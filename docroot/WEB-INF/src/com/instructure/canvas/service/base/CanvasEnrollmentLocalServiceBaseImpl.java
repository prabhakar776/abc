...
/**
 * Provides the base implementation for the canvas enrollment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.instructure.canvas.service.impl.CanvasEnrollmentLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CanvasEnrollmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CanvasEnrollmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.instructure.canvas.service.CanvasEnrollmentLocalServiceUtil} to access the canvas enrollment local service.
	 */
	...
	@Override
	public CanvasEnrollment addCanvasEnrollment(
		CanvasEnrollment canvasEnrollment) throws SystemException {
		canvasEnrollment.setNew(true);

		return canvasEnrollmentPersistence.update(canvasEnrollment);
	}
	 ...
	 */
	@Override
	public CanvasEnrollment createCanvasEnrollment(long courseId) {
		return canvasEnrollmentPersistence.create(courseId);
	}
	...
	@Override
	public CanvasEnrollment deleteCanvasEnrollment(long courseId)
		throws PortalException, SystemException {
		return canvasEnrollmentPersistence.remove(courseId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CanvasEnrollment deleteCanvasEnrollment(
		CanvasEnrollment canvasEnrollment) throws SystemException {
		return canvasEnrollmentPersistence.remove(canvasEnrollment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CanvasEnrollment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return canvasEnrollmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return canvasEnrollmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CanvasEnrollment fetchCanvasEnrollment(long courseId)
		throws SystemException {
		return canvasEnrollmentPersistence.fetchByPrimaryKey(courseId);
	}
	 ...
	 */
	@Override
	public CanvasEnrollment getCanvasEnrollment(long courseId)
		throws PortalException, SystemException {
		return canvasEnrollmentPersistence.findByPrimaryKey(courseId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return canvasEnrollmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CanvasEnrollment> getCanvasEnrollments(int start, int end)
		throws SystemException {
		return canvasEnrollmentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCanvasEnrollmentsCount() throws SystemException {
		return canvasEnrollmentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CanvasEnrollment updateCanvasEnrollment(
		CanvasEnrollment canvasEnrollment) throws SystemException {
		return canvasEnrollmentPersistence.update(canvasEnrollment);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.instructure.canvas.model.CanvasEnrollment",
			canvasEnrollmentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = canvasEnrollmentPersistence.getDataSource();
	...
	private CanvasEnrollmentLocalServiceClpInvoker _clpInvoker = new CanvasEnrollmentLocalServiceClpInvoker();
}