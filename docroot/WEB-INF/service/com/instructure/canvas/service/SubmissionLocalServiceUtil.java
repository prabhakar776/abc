 ...
 * {@link com.instructure.canvas.service.impl.SubmissionLocalServiceImpl} and is the
 ...
 * @see com.instructure.canvas.service.impl.SubmissionLocalServiceImpl
 * @generated
 */
public class SubmissionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.instructure.canvas.service.impl.SubmissionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.instructure.canvas.model.Submission addSubmission(
	...
	*/
	public static com.instructure.canvas.model.Submission createSubmission(
		long submissionId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.instructure.canvas.model.Submission deleteSubmission(
		long submissionId)
	...
	*/
	...
	public static com.instructure.canvas.model.Submission fetchSubmission(
		long submissionId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.instructure.canvas.model.Submission getSubmission(
		long submissionId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.instructure.canvas.model.Submission> getSubmissions(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.instructure.canvas.model.Submission updateSubmission(
		com.instructure.canvas.model.Submission submission)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static java.util.List<com.instructure.canvas.model.Submission> getCompletionSubmissions(
		long courseId) {
		return getService().getCompletionSubmissions(courseId);
	}

	public static com.instructure.canvas.model.Submission getCompletionSubmission(
		long courseId, long canvasUserId) {
		return getService().getCompletionSubmission(courseId, canvasUserId);
	}

	public static java.util.List<com.instructure.canvas.model.Submission> getCompletionSubmissions(
		long courseId, long canvasUserId) {
		return getService().getCompletionSubmissions(courseId, canvasUserId);
	}

	public static java.util.List<com.instructure.canvas.model.Submission> getSubmissionHistory(
		...
		return getService()
				   .getSubmissionHistory(studentId, assignmentIds, courseId);
	}
