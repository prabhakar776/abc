...
/**
 * Provides the local service interface for ActivityStream. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ActivityStreamLocalServiceUtil
...
public interface ActivityStreamLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ActivityStreamLocalServiceUtil} to access the activity stream local service. Add custom service methods to {@link com.instructure.canvas.service.impl.ActivityStreamLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
