...
/**
 * Provides the remote service interface for Award. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see AwardServiceUtil
...
public interface AwardService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AwardServiceUtil} to access the award remote service. Add custom service methods to {@link com.instructure.canvas.service.impl.AwardServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
