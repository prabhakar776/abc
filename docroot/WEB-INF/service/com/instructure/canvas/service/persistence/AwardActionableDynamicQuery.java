 ...
 * @generated
 */
public abstract class AwardActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public AwardActionableDynamicQuery() throws SystemException {
		setBaseLocalService(AwardLocalServiceUtil.getService());
		setClass(Award.class);

		setClassLoader(com.instructure.canvas.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("awardId");
	}
}