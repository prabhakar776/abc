 ...
 * @generated
 */
public class CanvasCourseCopyLocalServiceClp
	implements CanvasCourseCopyLocalService {
	public CanvasCourseCopyLocalServiceClp(
	...
	public void copyCourse(java.lang.String sourceCourseId,
		...
		try {
			_invokableLocalService.invokeMethod(_methodName3,
				...
				new Object[] {
					ClpSerializer.translateInput(sourceCourseId),
					
				ClpSerializer.translateInput(newCourseId)
				});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
